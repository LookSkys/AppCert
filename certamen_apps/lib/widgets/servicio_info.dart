...
ServicioDetalle({required this.nombre_servicio, required this.nombre, required this.foto,required this.lugar, required this.horario, required this.tipo_servicio});
        ...
        child: Column(
          children: [
            Container(
              ...
              child: 
                Image(image: AssetImage('assets/images/${this.foto}'),width: 300, height: 300,),
            ),
            SizedBox(height: 20),
            //CUADRO DE INFO
