        ...
        child: Column(
          children: [
            Container(
              ...
              child: 
                Image(image: AssetImage('assets/images/chidi.jpg'),width: 300, height: 300,),
            ),
            SizedBox(height: 30),
            //CUADRO DE INFO
            ...
            Row(
              ...
              children: [
                ...
                style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,fontFamily: 'VT323' ,color: Colors.white),
                ),
                SizedBox(height: 30)
              ],
            ),
            ...
            Row(
              children: [
                ...
                Image(image: AssetImage('assets/images/chile.png'),width: 20, height: 20,)
              ],
            ),
            //EDAD
            Row(
            ...
            Row(
              children: [
                Text('genero: ', style: estilo_seccion),
            ...
            Row(
              children: [
                Text('Cantidad de asesinatos: ', style: estilo_seccion),
                Text('140 asesinatos ', style: estilo_dato),
